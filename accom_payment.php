...
$price = ($room === "AC room") ? 800 : 500; // Example prices in INR
?> 
<!DOCTYPE html>
<html>
<head>
    ...
    <link rel="stylesheet" href="accom_payment.css?v=1.0">
    ...
    <div class="payment-summary">
       ...
       <p>Price: ₹<?php echo $price; ?></p>
        ...
        <form action="abooking.php" method="post">
            ...
            <input type="hidden" name="photoId" value="<?php echo $photo_id_type; ?>">
            <input type="hidden" name="photoIdNo" value="<?php echo $photo_id_no; ?>">
